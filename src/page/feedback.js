...
import PartFeedback from "./part_feedback";
            ...
            <div>
                ...
                <div id="report_main">
                    ...
                    <div className="part_result">
                        {(this.state.current_part === PART_A) && <PartFeedback part={PART_A} reuslt_json={ response_json_A}></PartFeedback>}
                        {(this.state.current_part === PART_B) && <PartFeedback part={PART_B} reuslt_json={ response_json_B}></PartFeedback>}
                    </div>
                </div>
            </div>
        );
